    ...
    return `
      <div class="welcome-step">
        ...
        <div class="integrations-grid">
          ...
          <div class="integration-card" data-integration="enableLinkedInJobsIntegration">
            <div class="integration-icon">
              <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <div class="integration-info">
              <h3>LinkedIn Jobs</h3>
              <p>Extract job listings and details</p>
            </div>
            <label class="integration-toggle">
              <input type="checkbox" checked data-integration="enableLinkedInJobsIntegration">
              <span class="toggle-slider"></span>
            </label>
          </div>
        </div>
