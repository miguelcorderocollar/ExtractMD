// Sidebar Last Extraction Module
// Display last extraction status in disabled mode
...
export function loadLastExtraction() {
  const section = document.getElementById('lastExtractionSectionDisabled');
  const statusEl = document.getElementById('lastExtractionStatusDisabled');
